...
const Testimonial = () => {
  return (
    <div className="w-full bg-[#f7f6e7] py-12 overflow-hidden">
      {/* Centered Heading */}
      ...
      >
        {[...testimonials, ...testimonials].map((testimonial, index) => (
          <div
            key={index}
            className="flex flex-col items-center bg-zinc-100 rounded-xl shadow-md p-6 min-w-[250px] sm:min-w-[300px] max-w-[300px] mx-2"
          >
            {/* Image */}
            <img
