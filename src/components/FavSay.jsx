...
const testimonials = [
  ...
  },
  {
    ...
    feedback:
      "Fokus gives me the clarity and energy I need to perform and create content all day without crashing.",
  },
];

export default function FavSay() {
  return (
    <section className="bg-[#fffdee] py-16 px-4 sm:px-8 md:px-12">
